// Bu dosya, Türkiye'deki illeri ve ilçeleri içerir.
// Verileri dışarıdan kullanılabilir hale getirmek için 'export' anahtar kelimesi kullanılır.
...
export const tr_cities = [
    ...
    { name: 'Tekirdağ', districts: ['Çerkezköy', 'Çorlu', 'Ergene', 'Hayrabolu', 'Kapaklı', 'Malkara', 'Muratlı', 'Saray', 'Süleymanpaşa', 'Şarköy'] },
